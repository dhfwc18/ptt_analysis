...
from ptt_crawler.crawler import (
    _get_all_content_urls,
    _get_comments,
    _get_content,
    _get_soup,
    crawl,
...
class TestPttCrawler(unittest.TestCase):
    ...
    def setUp(self):
        with open(MOCK_HTML_PATH, encoding="utf-8") as file:
    ...
    def test_get_soup_success(self, mock_get):
        ...
        result = _get_soup("https://test.url")
        self.assertIsInstance(result, BeautifulSoup)

    @patch("requests.get")
    def test_get_soup_retry_on_error(self, mock_get):
    ...
    @patch("ptt_crawler.crawler._get_soup")
    def test_get_all_content_urls(self, mock_get_soup):
        ...
        self.assertTrue(all(url.startswith("https://www.ptt.cc/") for url in urls))
